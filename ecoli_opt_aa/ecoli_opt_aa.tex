...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Codon models to remidy problems of nucleotide and amino acid models
			\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{itemize}        
		\end{itemize}
		\item Idealy, we would use better models and additional data.
	\end{itemize}
	\item We assess the reliability of selection on amino acids infered by DMS to inform phylogenetic studies.
	\begin{itemize}
	...
	\end{itemize}
	\item \selac is an improvement over DMS.
	\begin{itemize}
