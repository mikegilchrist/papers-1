...
Models with site specific selection on amino acids improved model fits by 917 to XXX AICc units over codon or nucleotide models without site specific selection (Table \ref(tab:AIC)).
In addition, \selac does outperform \phydms by XXX to  XXX AICc units.
