...
\begin{table}
  ...
  See Table \ref{tab:AIC_full} for all models tested.}
  \label{tab:AIC}
\end{table}
...
The genetic load in SHV is lower than in TEM with the exception of residues found in $\beta$-sheets and the active site (Table \ref{tab:selection}).
