...
The \selac fit shows high model adequacy.
...
Together this suggests that DMS selection estimates are not informative about selection in the wild and that \selac is a more appropriate tool to obtain such estimates.
...
We also find that the genetic load is inconsistent with the observed genetic variation in TEM.
\selac predicts a zero genetic load at invariant sites.
...
This is consistent with predictiones discussed above.
