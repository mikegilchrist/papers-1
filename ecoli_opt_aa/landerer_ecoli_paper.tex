...
% Insert your title:
\noindent{\Large \bf Site specific, \PC based phylogenetic models outperform experimentally informed models and overcome their laboratory bias}
\bigskip
...
As indicated previously, the genetic load of the observed TEM sequences differs greatly under the \selac and experimentally estimated selection parameters.
...
\selac on the other hand, better explains the evolution of TEM in the wild and does not require the supplementary selection data but provides such estimates from the sequence data.
