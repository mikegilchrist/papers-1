...
Our results show that site specific selection inferred by DMS improve model fit and are consistent with previous work \citep{bloom2014,bloom2017}, but supplementing phylogenetic inference with unnatural data causes poor model adequacy. 
...
\phydms, parameterized by site specific selection estimates from \citet{stiffler2016} performs second best and provides an improvement of 337 AIC units for the best non-site specific model, the symmetric nucleotide model by \citet{zharkikh1994}. 
