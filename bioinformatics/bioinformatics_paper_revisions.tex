...
\textcolor{red}{In order} \textcolor{blue}{To} protect users from computer failures or aid in the collection of additional MCMC samples, \package \textcolor{blue}{can} periodically produce output files which can be used to restart an MCMC chain from a previous time point.
