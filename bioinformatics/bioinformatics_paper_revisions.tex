...
Finally, \package \textcolor{red}{also comes with} \textcolor{blue}{contains} a set of visualization routines and the ability to revisit or reinitiate previous model fitting, providing researchers with a well rounded easy to use framework to analyze genome scale data.
