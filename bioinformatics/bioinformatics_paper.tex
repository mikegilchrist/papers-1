...
\package implements a mixture distribution for population-level parameters, allowing these parameters to be estimated under the assumption of different biological conditions.
