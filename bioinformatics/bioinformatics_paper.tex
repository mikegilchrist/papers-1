...
\pkg{\package} is an R package for estimating biological parameters, such as selection against translation inefficiency, nonsense error rates, and ribosome pausing times, for sets of genes based on codon or amino acid data.
...
Current models within \package can accurately estimate model parameters given either coding sequences or ribosome foot-printing data.
