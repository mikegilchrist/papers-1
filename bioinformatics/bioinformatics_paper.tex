...
Finally, \package also comes with a set of visualization tools and the ability to revisit or reinitiate previous model fittings, providing researchers with a well rounded easy to use framkework.
