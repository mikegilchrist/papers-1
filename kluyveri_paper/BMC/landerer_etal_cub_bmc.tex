...
\begin{figure}
     \centering
	%\includegraphics[width=\textwidth]{img/figS1.pdf}
	\caption{Codon usage patterns for 19 amino acids. Amino acids are indicated as one letter code. 
	The amino acids Serine was split into two groups (S and Z) as Serine is coded for by two groups of codons that are separated by more than one mutation.
...
\begin{figure}
     \centering
	%\includegraphics[width=0.5\textwidth]{img/figS3.pdf}
...
\begin{figure}
    ...
    \begin{subfigure}
        \centering
       % \includegraphics[width=.45\textwidth]{img/figS4a.pdf}
    \end{subfigure}
    \begin{subfigure}
        \centering
        %\includegraphics[width=.45\textwidth]{img/figS4b.pdf}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}
        \centering
       % \includegraphics[width=.45\textwidth]{img/figS5a.pdf}
    \end{subfigure}
    \begin{subfigure}
        \centering
        %\includegraphics[width=.45\textwidth]{img/figS5b.pdf}
    \end{subfigure}
...
\begin{figure}
     \centering
	%\includegraphics[width=.5\textwidth]{img/figS6.pdf}
...
\begin{figure}
     \centering
	%\includegraphics[width=.5\textwidth]{img/figS7.pdf}
