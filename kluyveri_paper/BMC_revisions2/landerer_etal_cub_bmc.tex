...
Similar, the predicted protein synthesiis rate $\phi$ of the endogenous ($\rho=0.73$, $p<10^{-10}$)  and exogenous ($\rho=0.88$, $p=p<10^{-10}$)  randomized gene set is highly correlated with our canonical predictions of $\phi$ (Figure \ref{fig:rnd_phi} a,b).
