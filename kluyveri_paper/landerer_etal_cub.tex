...
In addition, using our estimates of mutation and selection bias, we identify \textit{Eremothecium gossypii} as the most likely source lineage, estimate the introgression occurred $\sim 6\times 10^8$ generation ago, and estimate its historic and current genetic load.
...
While previous work by \citet{payen2009} showed a preference for GC rich codon in the exogenous genes our results provide more nuanced insights.
Our results indicate that the difference in \GC between endogenous and exogenous genes is mostly due to differences in mutation bias as 95 \% of all codon families show a strong mutation bias towards G/C ending codons.
...
%	\caption{Synteny relationship of \gossypii (roman numerals) and the exogenous, introgressed region C-Left. Indicated is the \GC content of the introgressed region in \kluyveri.}
%	\label{fig:synt_rel}
%\end{figure}
%\null
%\vfill
