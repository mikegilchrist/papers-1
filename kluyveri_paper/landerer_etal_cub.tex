...
\title{Unlocking a signal of introgression from codons in \textit{Lachancea kluveri} using a mutation-selection model}
...
We find that the selection against the exogenous genes \GL due to mismatched codon usage was -0.0008 at the time of the introgression and still is -0.0003 today.
...
We find large selection against the exogenous genes due to mismatched codon usage, resulting in an astronomically small fixation probability, and making fixation extremly unlikely.
With such a small fixation probability, ($(1-\exp[-\GL])/(1-\exp[-2\GL N_e]) \approx 10^{-6952}$) one or more advantageous loci had to drive the introgressed genes to fixation.
...
In this context, the astronomically small fixation probability indicates that there was virtually no chance of fixation and was likely not a fluke, and unless there was a severe bottleneck with $N_e < 1/|s| \approx 1,250$ around the time of introgression, which conceivably could have been triggered by a speciation event, this scenario seems, thus, very unlikely.

If, on the other hand, the introgressed region contained advantageous loci, the effective selection against the exogenous genes would be reduced and the introgression could have even been advantageous.
...
These exapted loci, however, are already accounted for in our calculation of \GL.
Thus, loci that, at the time of the introgression, provided a benefit to \kluyveri must have been contained in the introgressed region
Alternatively, an environmental shift may have caused the replaced endogenous region to suddenly contain deleterious loci making the reduction in translation efficiency the lesser of two evil.
...
%These similarities in \DM and \DE parameters suggest that the genetic load for \emph{S.~pastorianus} due to mismatching codon usage is small relative to the exongenous genes considered here. 
