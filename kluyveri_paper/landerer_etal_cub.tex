...
%The origin the introgression is currently unknown, but 
...
Two of the ten candidate lineages utilize the alternative yeast nuclear code (codon table 12). 
...
%NOTES about equilibrium assumption
%- I am somewhere more/less likely than I expect to be
%- If I got a gene showing adaptation, overadapted region is smaller than underadapted region
...
While we were only able to consider a subset of exogenous genes for our phylogenetic analysis, these genes provide further evidence that the exogenous genes could originate from a lineage that does not belong to the Lachancea clade.
...
If the ancestral mutation environments were more similar (dissimilar) at the time of the introgression then our result is an overestimate (underestimate).
...
%A careful analysis of intra-specific genetic variation within the endogenous and exongenous regions could help us distinguish between these various scenarios.
