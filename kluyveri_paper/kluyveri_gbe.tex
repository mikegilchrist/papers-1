...
More specifically, we utilize the Ribosome Overhead Cost (ROC) version of \citet{ShahAndGilchrist2011} of the more general Stochastic Evolutionary Model of Protein Production Rates (SEMPPR) introduced in \citet{Gilchrist2007} using the R software package \text{AnaCoDa}\citet{LandererEtAl2018}.   
