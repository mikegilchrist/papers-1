...
More specifically, we utilize the Ribosome Overhead Cost (ROC) version of \citet{ShahAndGilchrist2011} of the more general Stochastic Evolutionary Model of Protein Production Rates (SEMPPR) introduced in \citet{Gilchrist2007} using the R software package \textt{AnaCoDa}\citet{LandererEtAl2018}.   
...
Our estimates of \DM  for the endogenous and exogenous genes were negatively correlated ($\rho = -0.49$),  indicating strong discordance between the two mutation environments  (Figure \ref{fig:csp_comp}).
