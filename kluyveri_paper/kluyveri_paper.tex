...
\begin{itemize}
	...
	\begin{itemize}
		\item Compare Rokas data set mean rate of evolution in Cleft and Main: no difference.
		\item distribution of $Ne*s$. How many genes in cleft/main are above, below $1/Ne$?
	\end{itemize}
	\item CUB provides candidates for origin.
	\item Compare to CAI, how many yeasts could be considered origin?
