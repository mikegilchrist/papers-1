...
We find that the genetic load due to mismatched codon usage was XX at the time of the introgression and still represents a genetic load of XX today.
...
Assuming one round of meiosis for every 1000 rounds of mitosis an effective population size $N_e$ on the order of $10^8$ \citep{wagner2005} and rapid fixation of the introgression, implies $10^{18}$ to $10^{19}$ opportunities for such an event to have occurred.
