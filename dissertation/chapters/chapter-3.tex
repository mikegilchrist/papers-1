...
This behavior is due, in part, to constraining $E[\phi] = 1$.
This constraint not only allows us to compare the efficacy of selection across genomes, but extremely small variances in the $\phi$ values estimated by \ROC, could indicate that a genome contains the signature of multiple cellular environments.
