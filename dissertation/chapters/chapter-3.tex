...
In contrast to other approaches used to study codon usage like CAI \citep{sharp1987} or tAI \citep{dosreis2004}, \ROC incorporates the effects of mutation bias and amino acid composition explicitly\cite{CopeEtAl2018}.
...
\subsection{Model Fidiverges enough from larger population.
Alternatively, larger population loses synteny, is that what our results suggest?
Can a yeast population become temporarily isolated?tting with \ROC}
